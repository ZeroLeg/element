<template>
  <div>
    <el-tabs v-model="currentTab">
      <el-tab-pane label="Url de canales" name="m3u"
        ><el-input
          :model-value="m3uUrl"
      ...
      >
      <el-tab-pane label="Datos de usuario" name="xtream"
        ><el-input
...
const { m3uUrl, xtreamHost, xtreamUser, xtreamPass } = defineProps({
  mode: String,
  m3uUrl: String,
  xtreamHost: String,
  xtreamUser: String,
